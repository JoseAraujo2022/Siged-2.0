...
<head>
  ...
  <link rel="stylesheet" href="http://cdn.datatables.net/1.11.6/css/jquery.dataTables.css">
  <!-- Agrega el archivo de idioma en español -->
  <link rel="stylesheet" href="https://cdn.datatables.net/plug-ins/1.11.6/i18n/Spanish.json">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Pages Collapse 1 Menu -->
      <li class="nav-item">
      ...
      <!-- Nav Item - Pages Collapse 2 Menu -->
      <li class="nav-item">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div>
                    ...
                    <span class="font-weight-bold">Se ha actualizado la tabla de deportes general!</span>
                  </div>
                </a>
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="mr-3">
                  ...
                  <div>
                    ...
                    Se han hecho cambios en la tabla general!
                  </div>
                </a>
                <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="mr-3">
                  ...
                  <div>
                    ...
                    Hemos notado usos inusuales en el usuario de dtm1.
                  </div>
                </a>
                <a class="dropdown-item text-center small text-gray-500" href="#">Mostras todas las Alertas</a>
              </div>
            </li>
